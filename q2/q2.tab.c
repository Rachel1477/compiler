...
{
       0,   106,   106,   111,   125,   133,   149,   156,   132,   168,
     174,   180,   185
};
#endif
...
static const yytype_int8 yytable[] =
{
      ...
      17,    22,     5,     9,    10,    18,    12,    21,     0,    24
};

static const yytype_int8 yycheck[] =
{
      10,     3,     5,     5,     3,     4,    11,    12,    18,    12,
      13,    21,     9,     0,    10,     6,    11,     7,    -1,     8
};
...
#line 112 "q2.y"
    {
        struct VarNode *current_var = (yyvsp[0].var_list);
        ...
        free_set((yyvsp[0].var_list));
        defined_set = add_var(defined_set, (yyvsp[-2].sval));
    }
#line 1162 "q2.tab.c"
    break;
...
#line 169 "q2.y"
    {
        (yyval.var_list) = union_sets((yyvsp[-2].var_list), (yyvsp[0].var_list));
        free_set((yyvsp[-2].var_list));
        free_set((yyvsp[0].var_list));
    }
#line 1225 "q2.tab.c"
    break;
...
#line 181 "q2.y"
    {
        (yyval.var_list) = NULL;
        (yyval.var_list) = add_var((yyval.var_list), (yyvsp[0].sval));
    }
#line 1244 "q2.tab.c"
    break;
